<%@ Page Title="Home Page" Language="C#" AutoEventWireup="true"
    CodeFile="SeniorService.aspx.cs" Inherits="_Default" %>
...
<html id="Html1" xmlns="http://www.w3.org/1999/xhtml" runat="server">
    ...
    <body>
        ...
        <form id="entity" runat="server">
            ...
            <br />
            <h2>
                Senior String Process Service
            </h2>
            <div id="rs1" class="servicediv" style="padding-left: 20px; padding-bottom: 20px; margin-top: 10px;">
                ...
                <p><a href="http://10.0.2.137/Top10Words/Service.svc">http://10.0.2.137/Top10Words/Service.svc</a></p>
                <p><a href="http://10.0.2.137/Top10Words/Service.svc?wsdl">http://10.0.2.137/Top10Words/Service.svc?wsdl</a></p>
                <p>string[] Top10Words(string url): Analyze the webpage at a given url and return the ten most-frequently occurred words</p>
                <p>
            ...
            <div id="rs2" class="servicediv" style="padding-left: 20px; padding-bottom: 20px; margin-top: 10px;">
                ...
                <p><a href="http://10.0.2.137/WordFilter/Service.svc">http://10.0.2.137/WordFilter/Service.svc</a></p>
                <p><a href="http://10.0.2.137/WordFilter/Service.svc?wsdl">http://10.0.2.137/WordFilter/Service.svc?wsdl</a></p>
                <p>
