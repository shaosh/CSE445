...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <table style="margin: 20px auto;" cellspacing="0">
        ...
        <tr>
            <td>Yunlong Jiang</td>
            <td><label><a href="http://10.0.2.137/allservices/Service.svc" />findNearestStore</label><br />
                <label><a href="http://10.0.2.137/allservices/Service.svc" />V-Lab URL</label>
            </td>
        ...
        <tr>
            <td>Yunlong Jiang</td>
            <td><label><a href="http://10.0.2.137/allservices/Service.svc" />WsHashOperations</label><br />
                <label><a href="http://10.0.2.137/allservices/Service.svc" />V-Lab URL</label>
            </td>
        ...
        <tr>
            <td>Yunlong Jiang</td>
            <td><label><a href="http://10.0.2.137/allservices/Service.svc" />compressString</label><br />
                <label><a href="http://10.0.2.137/allservices/Service.svc" />V-Lab URL</label>
            </td>
        ...
        <tr>
            <td>Yunlong Jiang</td>
            <td><label><a href="http://10.0.2.137/allservices/Service.svc" />stringMatching</label><br />
                <label><a href="http://10.0.2.137/allservices/Service.svc" />V-Lab URL</label>
            </td>
        ...
        <tr>
            <td>Yunlong Jiang</td>
            <td><label><a href="http://10.0.2.137/allservices/Service.svc" />bidirection_string_Convert_binary</label><br />
                <label><a href="http://10.0.2.137/allservices/Service.svc" />V-Lab URL</label>
            </td>
        ...
        <tr>
            <td>Yunlong Jiang</td>
            <td><label><a href="http://10.0.2.137/allservices/Service.svc" />CalulateSimiliarty</label><br />
                <label><a href="http://10.0.2.137/allservices/Service.svc" />V-Lab URL</label>
            </td>
        ...
        <tr>
            <td>Hao Yan</td>
            <td><label><a href="http://10.0.2.137/Hao_Yan_Services/Service.svc" />WsdlAddress</label><br />
                <label><a href="http://10.0.2.137/Hao_Yan_Services/Service.svc" />V-Lab URL</label>
            </td>
            <td  style="text-align: left; padding-left: 10px">Find all WSDL addresses in a web page.</td>
            <td><a href="http://10.0.2.137/Try_It_Test_Pages/" />Try it</td>
            <td>WCF svc</td>
        </tr>
        <tr>
            <td>Hao Yan</td>
            <td><label><a href="http://10.0.2.137/Hao_Yan_Services/Service.svc" />WsOperations</label><br />
                <label><a href="http://10.0.2.137/Hao_Yan_Services/Service.svc" />V-Lab URL</label>
            </td>
        ...
        <tr>
            <td>Hao Yan</td>
            <td><label><a href="http://10.0.2.137/Hao_Yan_Services/Service.svc" />CheckRotation</label><br />
                <label><a href="http://10.0.2.137/Hao_Yan_Services/Service.svc" />V-Lab URL</label>
            </td>
        ...
        <tr>
            <td>Hao Yan</td>
            <td><label><a href="http://10.0.2.137/Hao_Yan_Services/Service.svc" />CheckUnique</label><br />
                <label><a href="http://10.0.2.137/Hao_Yan_Services/Service.svc" />V-Lab URL</label>
            </td>
        ...
        <tr>
            <td>Hao Yan</td>
            <td><label><a href="http://10.0.2.137/Hao_Yan_Services/Service.svc" />ReplaceSpace</label><br />
                <label><a href="http://10.0.2.137/Hao_Yan_Services/Service.svc" />V-Lab URL</label>
            </td>
        ...
        <tr>
            <td>Hao Yan</td>
            <td><label><a href="http://10.0.2.137/Hao_Yan_Services/Service.svc" />FindLargestCommonSubstring</label><br />
                <label><a href="http://10.0.2.137/Hao_Yan_Services/Service.svc" />V-Lab URL</label>
            </td>
